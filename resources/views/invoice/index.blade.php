...
<div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form name="" action="{{ route('invoice.addinvoice') }}" method="POST" class="row g-3">
...
@if (empty($rec->pic) )
    ...
    <td><a href="" data-bs-toggle="modal" data-bs-target="#edit{{$rec->productId}}" class="btn btn-info">Edit </a>
                ...
                <a href="{{ route('invoice.deleteinvoiceitem',$rec->cartId)}}" class="btn btn-primary">Delete</a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Floating Labels Form -->
              <form name="" action="/updateinvoicequantity" method="POST" class="row g-3">
...
<tr>
                          ...
                          <td>&nbsp;</td>
													<td colspan="3">
														...
														<h5 class="text-success"><strong>Grand Total:   <?php  echo $payroll = getinvoiceCarttotal();
...
<div class="card">
            <div class="card-body">
              ...
              <!-- Floating Labels Form -->
              <form name="" action="{{ route('invoice.createinvoice') }}" method="POST" class="row g-3">
              @csrf
             <input type="hidden" id="_token" value="{{ csrf_token() }}">  
 ...
 <!-- 
                <div class="col-12">
                  <div class="form-floating">
                    <textarea name="note" class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;"></textarea>
