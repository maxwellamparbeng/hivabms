...
<div><b>Accra ShowRoom First Floor</b></div>
<div>Bechem House Near Avenida Hotel</div>
<div>Kojo Thomson Road, Adabraka - Accra</div>
<div>Tel:+233 501 258 419-21</div>
<div>+233 302 248 614</div>
...
<div><b>Tarkoradi ShowRoom</b> </div>
<div>Lands Commission Building</div>
<div>Opposite Prudential Bank
Liberation Road</div>
<div>Market Circle, Tarkoradi</div>
<div>Tel: 233 204 358 113</div>
<div>+233 204 358 117</div>
...
<?php   $customers = viewinvoicedetails($rec->transactionId);
...
<h1 class="invoice-id">{{ $customers['invoiceType'] }}- </h1>
...
<td colspan="2">VAT TAX {{ $customers['vatPercentage'] }}% +</td>
<td>
...
$customers = viewinvoicedetails($rec->transactionId);
