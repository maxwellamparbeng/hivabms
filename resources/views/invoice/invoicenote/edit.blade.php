...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="container mt-4">
            ...
            <form id="paymentForm" method="POST" action=" {{ route('invoice.updatenote', $user->noteId) }}" enctype="multipart/form-data" >
            ...
            <input type="hidden" id="_token" value="{{ csrf_token() }}">
                  ...
                  <input value="{{ $user->noteId }}" 
                        ...
                        <div class="mb-3">
                    <label for="title" class="form-label">Invoice Note</label>
                ...
                <a href="{{ route('invoice.manageinvoicenote') }}" class="btn btn-default">Back</a>
            </form>
        </div>
