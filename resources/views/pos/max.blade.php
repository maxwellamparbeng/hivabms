...
echo"</br> ";
            ...
            <div class="row">
                <div class="col-md-4"> <br> <span class="fw-bold">Net Pay : {{ $payroll['net'] }}</span> </div>
                <div class="border col-md-8">
                    <div class="d-flex flex-column"> <span>In Words</span> <span> <?php  echo $payroll = numberTowords($payroll['net']) ;
