...
echo"</br> ";
            ...
            ?>
                ...
                <div class="row">
                    ...
                    <?php  $payroll = calculatepayroll($rec->employeeId,$rec->payrollId );?>
                    
                    
                    @foreach ($payroll['allowance'] as $allow)
                        <tr>
                    ...
                    <tr class="border-top">
                            ...
                            <td></td>
                                    ...
                                    echo $payroll['allowance']->sum('amount');
                    ...
                    @foreach ($payroll['deduction'] as $deduct)
                        <tr>
                    ...
                    <td></td>
                            ...
                            echo $payroll['deduction']->sum('amount')+$payroll['ssnit']+$payroll['incomeTax'];
            ...
            <div class="row">
                <div class="col-md-4"> <br> <span class="fw-bold">Net Pay : {{ $payroll['netSalary'] - $payroll['deductionAmount'] }}</span> </div>
                <div class="border col-md-8">
                    <div class="d-flex flex-column"> <span>In Words</span> <span> <?php  echo $payroll = numberTowords($payroll['netSalary'] - $payroll['deductionAmount']) ;
