...
<div class="col-md-6">
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Verify Details</h5>

              <div class="container mt-4">


<form method="POST" action="{{ route('hivapay.hpfinalizereceivefunds') }}" >
    @csrf

    <div class="form-group">
        Transaction Id 
        <input readonly required type="text" name="transactionId" value="{{ session('transactionId') }}" class="form-control" id="exampleFormControlInput1" placeholder="****">
      </div>
