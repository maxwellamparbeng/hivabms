...
<div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form name="" action="{{ route('warehouse.updatewarehouseinventory') }}" method="POST" class="row g-3">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Warehouse Inventory</h5>
  ...
  @if(auth()->user()->can('warehouse.transferstock') )
  ...
  @endif
       ...
       @if(auth()->user()->can('warehouse.reducestock') )
    ...
    <a class="dropdown-item" href="{{ route('warehouse.transferstocklog',$rec->productId)}}">View Log</a>
          ...
          <div class="modal fade" id="transferstock{{ $rec->productId }}" tabindex="-1">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form id="paymentForm" method="POST" action="/transferwarehousestock"  >
       
                    @csrf
                     <input type="hidden" id="_token" value="{{ csrf_token() }}">
                     <input type="hidden" name="frombranchId" value="{{ $rec->warehouseId }}">
                    ...
                    <select class="form-control" name="tobranchId" required>
...
<form id="paymentForm" method="POST" action="{{ route('warehouse.reducestock') }}" enctype="multipart/form-data" >
