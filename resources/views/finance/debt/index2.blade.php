...
@section('content')
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createpayrolls">Add new account</button>
              ...
              <table class="table datatable ">
                ...
                <tr>
                    ...
                    @if(auth()->user()->can('account.edit') )
                      ...
                      <td><a href="{{ route('account.edit', $rec->accountId) }}" class="btn btn-info">Edit </a>
