...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="container mt-4">
            ...
            <form id="paymentForm" method="POST" action=" {{ route('branch.updatebranch', $user->branchId) }}" enctype="multipart/form-data" >
