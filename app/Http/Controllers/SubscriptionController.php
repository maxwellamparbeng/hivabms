...
class SubscriptionController extends Controller
{
    public function allsubscriptions() 
    {
        ...
        if($userInfo==5){
            ...
            $clients = DB::table('company')->join('subscriptions', 'subscriptions.companyId', '=', 'company.companyId')->join('subscription_tiers', 'subscription_tiers.subscriptionTierId', '=', 'subscriptions.TierSubscriptionsId')->orderBy('subscriptions.dateCreated', 'DESC')->get(); 
           ...
           if($usertype=="Admin"){
            ...
            $clients = DB::table('company')->join('subscriptions', 'subscriptions.companyId', '=', 'company.companyId')->join('subscription_tiers', 'subscription_tiers.subscriptionTierId', '=', 'subscriptions.TierSubscriptionsId')->where('company.companyId',$companyId)->orderBy('subscriptions.dateCreated', 'DESC')->get();  
           ...
           if($usertype=="SubAdmin"){
            ...
            $clients = DB::table('company')->join('subscriptions', 'subscriptions.companyId', '=', 'company.companyId')->join('subscription_tiers', 'subscription_tiers.subscriptionTierId', '=', 'subscriptions.TierSubscriptionsId')->where('company.companyId',$companyId)->orderBy('subscriptions.dateCreated', 'DESC')->get();  
            return view('subscription.company')->with('records',$clients);
           }
...
public function allcompanies() 
    ...
    if($userInfo==5){
        ...
        $clients = DB::table('company')->join('subscriptions', 'subscriptions.TierSubscriptionsId', '=', 'company.subscriptionTier')->join('subscription_tiers', 'subscription_tiers.subscriptionTierId', '=', 'subscriptions.TierSubscriptionsId')->get(); 
       ...
       if($usertype=="Admin"){
        ...
        $clients = DB::table('company')->join('subscriptions', 'subscriptions.TierSubscriptionsId', '=', 'company.subscriptionTier')->join('subscription_tiers', 'subscription_tiers.subscriptionTierId', '=', 'subscriptions.TierSubscriptionsId')->where('company.companyId',$companyId)->get(); 
